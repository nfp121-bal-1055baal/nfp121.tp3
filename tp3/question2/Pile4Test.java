 ...
 * @26-3-2019 (un numéro de version ou une date)
 * 
...
public class Pile4Test extends junit.framework.TestCase {
    ...
    public void test_Pile_toString() throws Exception {
        PileI pile4 = new question2.Pile4(3);
        assertEquals("toString incorrect ? ", "[]", pile4.toString());
        pile4.empiler(4);
        assertEquals("toString incorrect ? ", "[4]", pile4.toString());
        pile4.empiler(5);
        assertEquals("toString incorrect ? ", "[5, 4]", pile4.toString());
        pile4.empiler(3);
        assertEquals("toString incorrect ? ", "[3, 5, 4]", pile4.toString());
